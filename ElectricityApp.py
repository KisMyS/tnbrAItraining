...
im = Image.open('tenaga-nasional-berhad-logo-png-transparent.png')
...
new_data = {'Fan':[fan],'Refrigerator':[fridge],
...
st.subheader('The predicted Electricity Bill is RM' + str(pred))